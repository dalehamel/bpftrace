if(EMBED_CLANG)
  ...
  # TODO dalehamel
  # is there a way to inherit the number of jobs from a cmake variable?
  ProcessorCount(nproc)
  set(CLANG_BUILD_COMMAND "make -j${nproc}")
  set(LIBCLANG_INSTALL_COMMAND "mkdir -p <INSTALL_DIR>/lib/ && cp <BINARY_DIR>/lib/libclang.a <INSTALL_DIR>/lib/libclang.a")
